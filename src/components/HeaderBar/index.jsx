            ...
            <div className={className}>
                <Row align='center' justify='space-between'>
                    ...
                    <Row flex='auto' align='center' justify='center' className='header-ul'>
                        <Col align='center' justify='center' className="item" onClick={() => this.setState({ count: 0 })}>
                            <Badge
                        ...
                        <Col align='center' justify='center' className="item">{userInfoStore.isLogin ? this.login() : this.notLogin()}</Col>
                    </Row>
                </Row>
